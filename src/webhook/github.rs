...
mod tests {
    ...
    impl ScmProvider for MockScmProvider {
        ...
        async fn get_pr_status(
            ...
            _project: &str,
            _number: i64,
        ) -> crate::error::Result<PrStatus> {
            Ok(PrStatus::Open)
        }

        async fn get_pr_info(&self, _project: &str, _number: i64) -> crate::error::Result<PrInfo> {
            Ok(PrInfo {
        ...
        async fn get_pr_diff(&self, _project: &str, _number: i64) -> crate::error::Result<String> {
            Ok(String::new())
        }
        ...
        async fn get_reviews(
            ...
            _project: &str,
            _number: i64,
        ) -> crate::error::Result<Vec<CodeReview>> {
        ...
        async fn get_review_comments(
            ...
            _project: &str,
            _number: i64,
        ) -> crate::error::Result<Vec<ReviewComment>> {
            Ok(self.comments.lock().unwrap().clone())
        }

        async fn list_repos(&self, _org: &str) -> crate::error::Result<Vec<RemoteRepo>> {
            Ok(Vec::new())
        }
    }
