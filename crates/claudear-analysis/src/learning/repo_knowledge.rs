...
use claudear_core::types::{DiffAnalysis, PromotedInstruction, RepoKnowledge, ReviewPattern};
...
"#;
    ...
    fn test_learn_from_review_pattern_format_bracket_category() {
        ...
        let categories = vec![
            ...
            (claudear_core::types::ReviewCategory::Security, "security"),
            (
            ...
            (claudear_core::types::ReviewCategory::Other, "other"),
        ];
    ...
    fn test_learn_from_review_pattern_empty_pattern_text() {
        ...
        let pattern = claudear_core::types::ReviewPattern {
            id: 1,
            scm_repo: "org/repo".to_string(),
            category: claudear_core::types::ReviewCategory::Other,
