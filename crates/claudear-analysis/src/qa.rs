...
use chrono::Utc;
use claudear_config::config::AskConfig;
use claudear_core::error::Result;
use claudear_core::types::{BlockingQuestion, QaMatch};
use claudear_storage::FixAttemptTracker;

pub use claudear_core::types::normalize_text;
...
mod tests {
    use super::*;
    use claudear_core::types::QaKnowledgeEntry;
